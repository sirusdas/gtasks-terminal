"""
Module entry point for the gtasks_cli package.
...
# Also add the root directory to find setup_assistant
...
if len(sys.argv) > 1:
    ...
    if module_name == "setup_assistant":
        # Import and run the setup assistant from the root directory
        import setup_assistant
        sys.exit(setup_assistant.main())
